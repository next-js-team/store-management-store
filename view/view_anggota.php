								...
								<?php while ($row = $this->model->fetch($data)) {
									echo "
                                        <tr class='bg-white border-b'>
                                            ...
                                            <td class='px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900'>$row[5]</td>
                                            ...
                                            <td class='text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap'>$row[8]</td>
                                            <td class='text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap'>$row[9]</td>
